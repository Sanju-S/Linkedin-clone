    ...
    <>
      <Container>
        <ShareBox>
          ...
          <div>
            <button>
              <img className="photoIcon" src="/images/photo-icon.svg" alt="" />
              <span>Photo</span>
            </button>

            <button>
              <img className="videoIcon" src="/images/video-icon.svg" alt="" />
              <span>Video</span>
            </button>

            <button>
              <img className="eventIcon" src="/images/event-icon.svg" alt="" />
              <span>Event</span>
            </button>
